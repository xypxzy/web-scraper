...
def try_except_decorator(error_text="An error occurred"):
    """
    A decorator to handle try-except for any function.

    Args:
        error_text (str): Custom error message to log when an exception occurs.

    Returns:
       callable: Wrapped function with try-except block.
    """
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                logger.error(f"{error_text} in {func.__name__}: {e}")
                raise e
...
class TextAnalyzer(BaseAnalyzer):
    ...
    @try_except_decorator("Error analyzing sentiment")
    ...
    @try_except_decorator("Error performing contextual analysis")
    ...
    @try_except_decorator("Error lemmatizing and normalizing text")
    ...
    @try_except_decorator("Error analyzing keywords")
    ...
    @try_except_decorator("Error analyzing text structure")
    ...
    @try_except_decorator("Error analyzing emotions")
    ...
    @try_except_decorator("Error extracting text")
    ...
    @try_except_decorator("Error calculating text complexity")
    ...
    @try_except_decorator("Error calculating semantic similarity")
    ...
    @try_except_decorator("Error rewriting text with T5")
...
def _recommend_semantic_similarity(self, full_text: str, reference_keywords: List[Dict[str, Any]],
